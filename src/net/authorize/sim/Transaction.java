...
public class Transaction extends net.authorize.NVPTransaction implements ITransaction {
	...
	protected Hashtable<String, String> requestMap = new Hashtable<String, String>();
	private Hashtable<ResponseField, String> responseMap = new Hashtable<ResponseField, String>();
	 ...
	 */
	public static final Transaction createTransaction(Transaction transaction, Hashtable<ResponseField, String> responseMap) {
	...
	public String createForm(String formName, String formId, Button button) {
		...
		htmlFormBuffer.append("' ACTION='").append(this.environment.getNVPBaseUrl() + "/gateway/transact.dll");
